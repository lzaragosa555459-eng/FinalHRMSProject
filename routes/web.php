...
Route::get('/employees/{id}/edit', [HRController::class, 'updateEvent'])->name('hr.Crud.editEvent');
Route::put('/events/{id}', [CrudController::class, 'updateEvent'])->name('hr.Crud.editEvent');
