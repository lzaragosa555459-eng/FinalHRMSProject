            ...
            <div class="row g-3 mt-1">
                ...
                <div class="col-md-6">
                    <div class="card p-3 shadow-sm">
                        ...
                        <h4 class="fw-bold text-dark text-end">
                            ₱{{ number_format($firstCutoff, 2) }}
                        </h4>
                    </div>
                </div>
