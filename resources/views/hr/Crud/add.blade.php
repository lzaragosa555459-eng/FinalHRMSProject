                ...
                <form method="POST" action="{{ route('hr.Crud.add') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="employee_number" class="form-control" id="employee_number" placeholder="EMP-2024-001">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="address" class="form-control" id="address" rows="2" placeholder="Street, City, Province"></textarea>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="applicant_id" class="form-select" id="applicant_id">
